...
export const ACTIVE_CODES: CodeItem[] = [
  { code: '5KCCU', reward: '3x Lucky Spins, 5x Trait Rerolls, 5x Gems', status: 'Active', verifiedDate: 'September 2026', source: '5,000 CCU Community Milestone' },
  { code: '1KCCU', reward: '2x Lucky Spins, 5x Trait Rerolls, 5x Gems', status: 'Active', verifiedDate: 'September 2026', source: '1,000 CCU Milestone' },
  { code: 'UPDATE3', reward: '3x Lucky Spins, 7x Trait Rerolls, 7x Gems', status: 'Active', verifiedDate: 'September 2026', source: 'Update 3 Major Release' },
  { code: 'UPDATE2', reward: '2x Lucky Spins, 5x Trait Rerolls, 5x Gems', status: 'Active', verifiedDate: 'September 2026', source: 'Update 2 Balance Patch' },
  { code: 'UPDATE1', reward: '2x Lucky Spins, 3x Trait Rerolls, 3x Gems', status: 'Active', verifiedDate: 'September 2026', source: 'Update 1 Release' },
  { code: 'RELEASE', reward: '1x Lucky Spin, 2x Trait Rerolls, 2x Gems', status: 'Active', verifiedDate: 'September 2026', source: 'Global Launch Celebration' },
];
