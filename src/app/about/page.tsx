...
export const metadata: Metadata = {
  title: "About Anime Dice Wiki & Network Standards",
  description: "Learn about the Anime Dice fan wiki, our editorial testing process, and the Roblox Wiki Hub network.",
  robots: {
    index: false,
    follow: true,
  },
    ...
    <main className="min-h-[75vh] py-12 px-4 sm:px-6 max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-sm text-slate-300 mt-2 leading-relaxed">
          Independent player guide, probability calculators, and working redeem codes for Anime Dice.
        </p>
      </div>
